...
export const ROUTES = {
  HOME: "/",
  LINK_PORTAL_LOGIN: "/",
  PORTAL_LOGIN: "/portal/login/account",
  PORTAL_FORGOTPASS: "/portal/forgot",
  PORTAL_SSO_LOGIN: "/portal/sso/login",
  PORTAL_INVITED: "/portal/invited",
  PORTAL_RESET_PASS: "/portal/reset",
  PORTAL_SIGN_UP_WITH_EMAIL: "/portal/register/email",
  PORTAL_SIGN_UP_PAYMENT_PLAN: "/portal/register/payment/plan",
  PORTAL_SIGN_UP_PAYMENT_REVIEW: "/portal/register/payment/review",
  PORTAL_SIGN_UP_PAYMENT_DETAIL: "/portal/register/payment/detail",
  PORTAL_SIGN_UP_PAYMENT_FINISH: "/portal/register/payment/finish",
  PORTAL_SIGN_UP_ACCOUNT: "/portal/register/account",
  PORTAL_SIGN_UP_FRIEND: "/portal/register/friend",
  PORTAL_SIGN_UP_TEAM: "/portal/register/team",
  USER_HOME: "/user/home",
  USER_HOME_DISCOVER_MAIN: "/user/home/discover",
  USER_HOME_DISCOVER_POPULAR: "/user/home/discover/popular",
  USER_HOME_DISCOVER_SEARCH: "/user/home/discover/search",
  ...
  CONTACT: "/contact",
  CAREER: "/career",
  SUSTAINABILITY_AND_ENVIRONMENT: "/sustainability-and-environment",
  CORPORATE_SOCIAL_RESPONSIBILITY: "/corporate-social-responsibility",
  USE_OF_API: "/use-of-api",
  PRESS: "/Press",
  FAQ: "/faq",
  USES_CASES: "/uses-cases",
  DOWNLOAD: "/download",
